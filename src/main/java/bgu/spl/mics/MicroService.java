...
public abstract class MicroService implements Runnable {
    ...
    protected Map<Class<? extends Message> , Callback> callbackMap;
    protected MessageBus messageBus;
    protected Ewoks resources;
    ...
    public MicroService(String name) {
        ...
        resources=Ewoks.getInitialization();
        diary = Diary.getInitialization();
        confirm=false;
    }

    public  MessageBusImpl getMessageBus() // Singleton
    {
       return (MessageBusImpl) messageBus;
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message someMessage = messageBus.awaitMessage(this);
                callbackMap.get(someMessage.getClass()).call(someMessage);
            }
    ...
    public void setConfrimInitialization() {
        confirm=true;
    }

    public boolean getConfrimInitialization() {
        return confirm;
    }
}
